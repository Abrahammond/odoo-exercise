# Odoo Bootstrap Landing Page
Landing page hecha para Odoo.
## Descripción
El presente sitio web fue elaborado para la vacante de Web Designer en Odoo México.
Las tecnologías utlizadas fueron HTML, SCSS y Boostrap en su versión 5.3.8
Para la primer fase de diseño, realicé un prototipo en Figma tomando como referencia la imagen Mockup del ejercicio.
## Fases
-  **Fase 1** - Prototipo en Figma.
### Figma
-  [Vista en mesa de trabajo](https://www.figma.com/design/6Yrr0lbgTgGB9TRQBoAs7v/ODOO-DESIGN?node-id=0-1&t=Ntx0Eg8qRYI5m5hs-1)
-  [Vista de prototipo desktop](https://www.figma.com/proto/6Yrr0lbgTgGB9TRQBoAs7v/ODOO-DESIGN?node-id=0-1&t=Ntx0Eg8qRYI5m5hs-1)
...
- **LinkedIn**
- [in/abrahammond](https://www.linkedin.com/in/abrahammond/)
- **Portafolio**
- [abrahammond.app](https://abrahammond-dacr.vercel.app/)
